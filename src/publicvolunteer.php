...
function volunteer_add()
{
    ...
    $sql = 'INSERT INTO VOLUNTEER '.
      ...
      if ($stmt = $db->prepare($sql)) {
                $stmt->bind_param("sssssssssssdssssssss", $first, $middle, $last, $race, $ethnicity, $gender, $veteran_status, $volunteer_type, $refered_from, $birth_date, $email_address, $phone_number, $country, $street, $state, $city, $postal_code, $emergency_fname, $emergency_lname, $emergency_relationship);
                $stmt->execute();
